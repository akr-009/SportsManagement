...
<head>
  ...
  <tr>
  	<td width='186' height='103'>Coach Name:</td>
    <td height="96" colspan="2"><input type="text" name='routinename' value='<?php echo $row['tname'] ?>'></td>
    </tr>
  <tr>
    <td width="186" height="103">Coach Mobile Number:</td>
