...
<head>
    ...
    <title>SPORTS CLUB  | Coach Detail</title>
	...
	function myFunction()
	{
     ...
     <body class="page-body  page-fade" onload="collapseSidebar()">
		...
		<div class="sidebar-menu">
			...
			<div class="logo">
				<a href="main.php">
					<img src="logo2.jpg" alt="" width="192" height="100" />
				</a>
			</div>
  ...
  <tr>
    <td height="87" colspan="2">Coach Name:<?php echo $row['tname'] ?> &ensp;&ensp;&ensp;&ensp;&ensp; &ensp;&ensp;&ensp;&ensp;&ensp; &ensp;&ensp;&ensp;&ensp;&ensp; &ensp;&ensp;&ensp;&ensp;&ensp;  &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp; &ensp;&ensp;&ensp;&ensp;&ensp;<span align="right"> <img src="logo2.jpg" width="121" height="114"  alt=""/></span></td>
    </tr>
  <tr>
    <td width="190" height="98">Coach Mobile Number:</td>
    <td width="417"><?php echo $row['day1'] ?></td>
  </tr>
  <tr>
    <td height="80">Coach MailID:</td>
    <td><?php echo $row['day2'] ?></td>
  </tr>
  <tr>
    <td height="87">Sport Name:</td>
